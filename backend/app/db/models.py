from sqlalchemy import Column, Integer, String, Text, ForeignKey, DateTime, func, and_
...
class Character(Base):
    ...
    # Relationship with aliases - defined after Alias class to avoid circular reference
...
# Now we can define the relationships from the entity classes to Alias
Character.aliases = relationship(
    "Alias",
    primaryjoin=and_(
        Character.id == foreign(Alias.entity_id),
        Alias.entity_type == "character"
    ),
    viewonly=False,
...
Place.aliases = relationship(
    "Alias",
    primaryjoin=and_(
        Place.id == foreign(Alias.entity_id),
        Alias.entity_type == "place"
    ),
    viewonly=False,
...
Item.aliases = relationship(
    "Alias",
    primaryjoin=and_(
        Item.id == foreign(Alias.entity_id),
        Alias.entity_type == "item"
    ),
    viewonly=False,
    back_populates="item",
    cascade="all, delete-orphan"
